...
namespace Jube.App.Controllers.Query
{
    ...
    public class GetExhaustiveSearchInstancePromotedTrialInstanceErrorHistogramController : Controller
    {
        ...
        [HttpGet("{id:int}")]
        public async Task<ActionResult<List<GetExhaustiveSearchInstancePromotedTrialInstanceErrorHistogramQuery.Dto>>> GetAsync(int id, CancellationToken token = default)
        {
            try
            {
