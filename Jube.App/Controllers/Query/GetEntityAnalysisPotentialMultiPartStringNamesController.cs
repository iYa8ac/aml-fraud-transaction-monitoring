...
namespace Jube.App.Controllers.Query
{
    ...
    public class GetEntityAnalysisPotentialMultiPartStringNamesController : Controller
    {
        ...
        private readonly GetEntityAnalysisPotentialMultiPartStringNamesQuery query;
            ...
            IHttpContextAccessor httpContextAccessor, DynamicEnvironment dynamicEnvironment)
        {
            ...
            query = new GetEntityAnalysisPotentialMultiPartStringNamesQuery(dbContext, userName);
        }
