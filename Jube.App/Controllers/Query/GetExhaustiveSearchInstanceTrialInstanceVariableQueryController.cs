...
namespace Jube.App.Controllers.Query
{
    ...
    public class GetExhaustiveSearchInstancePromotedTrialInstanceVariableQueryController : Controller
    {
        ...
        private readonly GetExhaustiveSearchInstancePromotedTrialInstanceVariableQuery query;
            ...
            IHttpContextAccessor httpContextAccessor, DynamicEnvironment dynamicEnvironment)
        {
            ...
            query = new GetExhaustiveSearchInstancePromotedTrialInstanceVariableQuery(dbContext, userName);
        }
