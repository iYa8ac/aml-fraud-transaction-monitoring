...
namespace Jube.App.Validators
{
    ...
    {
        public EntityAnalysisModelAbstractionCalculationDtoValidator(EntityAnalysisModelAbstractionCalculationRepository repository)
        {
            RuleFor(p => p.Name)
                .NotEmpty()
            ...
            var abstractionCalculationTypes = new List<int>
            {
                1,
                2,
                3,
