...
namespace Jube.App.Validators
{
    ...
    {
        public EntityAnalysisModelReprocessingRuleDtoValidator(EntityAnalysisModelReprocessingRuleRepository repository)
        {
            RuleFor(p => p.Name)
                .NotEmpty()
            ...
            var reprocessingIntervalTypes = new List<string>
            {
                "n",
                "h",
                "d",
