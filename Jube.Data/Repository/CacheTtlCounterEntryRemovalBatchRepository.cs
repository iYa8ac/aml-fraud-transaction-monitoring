...
namespace Jube.Data.Repository
{
    ...
    public class CacheTtlCounterEntryRemovalBatchRepository(DbContext dbContext)
    {
        ...
        public Task FinishAsync(long cacheTtlCounterEntryRemovalBatchId, CancellationToken token = default)
        {
